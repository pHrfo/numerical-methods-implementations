...
public:
    ...
    double integralByGaussLegendre1(double, double);
    double integralByGaussLegendre2(double, double);
    double integralByGaussLegendre3(double, double);
    double integralByGaussLegendre4(double, double);
    double integralByGaussLegendre5(double, double);
